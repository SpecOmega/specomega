...
你可以使用 Vibecode 模块对生成式代码与模板化代码进行审计：
...
- `.specomega/reports/vibecode_report.json`
- `.specomega/reports/vibecode_report.md`
- `.specomega/reports/vibecode_report.html`
- `.specomega/reports/vibecode_report.csv`
- `.specomega/reports/vibecode_gate.txt`

通过 `.specomega/vibecode_config.json` 可配置阈值、风险规则和 `block_on` 策略，便于用于审批或合规门禁。
