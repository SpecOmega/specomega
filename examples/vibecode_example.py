...
def main() -> None:
    ...
    sample_text = "Autogenerated by Copilot from a prompt. Trace: prompt->model->patch. Intent: deliver login flow. Goal: reduce manual review. Source: local-git-server"
